...
public class MainActivity extends FragmentActivity implements FragmentChangeListner {
    ...
    private TextView textShipExact;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textShipExact = (TextView)findViewById(R.id.shipExactText);
        pbLogo = (ImageView)findViewById(R.id.pbLogo);
       // pDialog.getWindow().setGravity(Gravity.BOTTOM);
        splash = (ImageView)findViewById(R.id.Splash);
        fragFrame = (FrameLayout)findViewById(R.id.FragFrame);
            ...
            timer.schedule(new TimerTask() {
                ...
                public void run() {
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            if(allDone){
                                Log.e("from","pre Execute");
                                splash.setVisibility(View.GONE);
                                pDialog.setVisibility(View.GONE);
                                textShipExact.setVisibility(View.GONE);
                                pbLogo.setVisibility(View.VISIBLE);
                                fragFrame.setVisibility(View.VISIBLE);
                                timeOver = true;
                            }
                        }
                    });
