...
public class YourShipment extends AppCompatActivity {
    ...
    private TextView item, cost, duty, insurance, tax, otherTax, shipment, total, totalTextView,  arrival, isRestricted, irestriction, erestriction, crestriction, EccnTextView, COOTextView;
    ...
    private void clearData() {
        ...
        GlobalDataHolder.setCOO("");
        GlobalDataHolder.setECCN("");
    ...
    private void initiateView() {
        ...
        EccnTextView = (TextView)findViewById(R.id.EccnTextView);
        COOTextView = (TextView)findViewById(R.id.COOTextView);
    ...
    private void setData() {
        ...
        EccnTextView.setText(GlobalDataHolder.getECCN().isEmpty()?"Licence required":"No licence required");
        COOTextView.setText(GlobalDataHolder.getCOO().isEmpty()?"Not predicted":GlobalDataHolder.getCOO());
