...
public class GlobalDataHolder {
    ...
    private static String ECCN= "", COO = "";
    ...
    public static String getECCN() {
        return ECCN;
    }
    public static void setECCN(String eccn) {
        GlobalDataHolder.ECCN = eccn;
    }

    public static String getCOO() {
        return COO;
    }
    public static void setCOO(String coo) {
        GlobalDataHolder.COO = coo;
    }
